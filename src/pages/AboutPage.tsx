...
const AboutPage = () => {
    ...
    const algoritmSteps = new AlgoritmSteps(text, { splitBy: 'letter', value: 1})
        .mixString('reverseMix').stepSortString('random') // separation word and swaping use!!! random scheme use!!!
